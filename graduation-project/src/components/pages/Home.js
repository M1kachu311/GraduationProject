  ...
  render() {
    return (
      <>
        <ImagesCarousel />
        <div style={mainStyle}>
          <HomeCards title={jobCardTitle} subtitle={jobCardSubtitle} />
          <HomeCards
          ...
          <iframe
            ...
            src="http://www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2Fzvi.yeruham&width=250&height=600&stream=true&header=true"
