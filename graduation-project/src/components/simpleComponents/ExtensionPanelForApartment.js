        ...
        <ExpansionPanel style={expansionPanelStyle} expanded={expanded === 'panel1'} onChange={this.handleChange('panel1')}>
            <ExpansionPanelSummary style={expansionHeaderStyle}>
                <div style={jobDetailsStyle}>
                    ...
                    <i style={pStyle} className="fas fa-chevron-down"></i>                
                </div>
            </ExpansionPanelSummary>
          <ExpansionPanelDetails style={expandedPanelDisplay}>
            <Typography>
                <p><b style={bold}>כתובת: </b>{this.props.address}</p>
                <p><b style={bold}>תיאור הנכס: </b>{this.props.description}</p>
                <p><b style={bold}>שׁם בעל הנכס: </b>{this.props.name}</p>
                <p><b style={bold}>מספר טלפון בעל הנכס: </b>{this.props.phone}</p>
            </Typography>
